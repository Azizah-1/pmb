    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        <section class="relative bg-white shadow-md rounded-lg overflow-hidden mt-8 animate-up">
            ...
            <div class="absolute inset-0 bg-black bg-opacity-60 flex flex-col justify-center items-center text-center p-10">
                <h1 class="text-white text-5xl font-extrabold mb-4 leading-tight max-w-4xl">Proses Engineering D3</h1>
                <p class="text-white text-xl mb-8 max-w-3xl">Program vokasi yang fokus pada operasi dan pengendalian proses industri kimia dan manufaktur.</p>
        ...
        <section class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-12">
            <div class="bg-brand-cream p-8 rounded-lg shadow hover:shadow-lg transition-all duration-300 text-center animate-up hover:bg-brand-jeruk-100">
                <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=72&q=80" alt="Operasi Proses" class="mx-auto mb-6 rounded-full border-4 border-brand-jeruk/20">
                <h3 class="text-2xl font-semibold mb-3 text-brand-jeruk">Operasi Proses</h3>
                <p class="text-gray-700 leading-relaxed">Pelajari operasi unit proses seperti distilasi, ekstraksi, dan reaksi kimia.</p>
            </div>
            <div class="bg-brand-cream p-8 rounded-lg shadow hover:shadow-lg transition-all duration-300 text-center animate-up hover:bg-brand-jeruk-100">
                <img src="https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=72&q=80" alt="Kontrol Proses" class="mx-auto mb-6 rounded-full border-4 border-brand-jeruk/20">
                <h3 class="text-2xl font-semibold mb-3 text-brand-jeruk">Kontrol Proses</h3>
                <p class="text-gray-700 leading-relaxed">Sistem kontrol otomatis dan monitoring parameter proses industri.</p>
            </div>
            <div class="bg-brand-cream p-8 rounded-lg shadow hover:shadow-lg transition-all duration-300 text-center animate-up hover:bg-brand-jeruk-100">
                <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=72&q=80" alt="Safety & HSE" class="mx-auto mb-6 rounded-full border-4 border-brand-jeruk/20">
                <h3 class="text-2xl font-semibold mb-3 text-brand-jeruk">Safety & HSE</h3>
                <p class="text-gray-700 leading-relaxed">Protokol keselamatan kerja dan manajemen risiko di industri proses.</p>
            </div>
        </section>

        <!-- Call to Action Banner -->
        <section class="bg-brand-jeruk text-white text-center py-20 rounded-lg mt-20 shadow-lg">
            <h2 class="text-4xl font-bold mb-6 max-w-3xl mx-auto">Bergabunglah dengan Program Studi Proses Engineering D3.</h2>
        ...
        <section class="mt-20 max-w-4xl mx-auto px-4">
            <blockquote class="border-l-8 border-brand-jeruk pl-8 italic text-gray-800 text-lg leading-relaxed bg-brand-cream p-6 rounded-r-lg">
                "Program vokasi yang memberikan keterampilan praktis untuk operasi proses industri kimia."
                <footer class="mt-6 font-semibold text-right text-brand-jeruk">- Alumni Proses Engineering</footer>
            </blockquote>
        </section>
        ...
        <section class="mt-20 grid grid-cols-1 md:grid-cols-2 gap-20 max-w-6xl mx-auto px-4">
            <div>
                ...
                <ul class="list-disc list-inside text-gray-700 space-y-4">
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Kimia Dasar & Organik</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Operasi Unit Proses</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Kontrol Proses & Instrumentasi</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Keselamatan Kerja Industri</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Laboratorium Analitik</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Manajemen Kualitas</a></li>
                </ul>
            </div>
            <div>
        ...
        <section class="mt-20 text-center max-w-5xl mx-auto px-4">
            ...
            <div class="flex flex-wrap justify-center gap-16">
                ...
                <div class="w-40 group">
                    ...
                    <p class="text-gray-600 text-base">Ahli Proses</p>
                </div>
                <div class="w-40 group">
                    <div class="relative mb-6">
                        <div class="absolute inset-0 bg-brand-jeruk rounded-full opacity-0 group-hover:opacity-20 transition-opacity"></div>
