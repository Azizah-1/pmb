    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        <section class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-12">
            <div class="bg-brand-cream p-8 rounded-lg shadow hover:shadow-lg transition-all duration-300 text-center animate-up hover:bg-brand-jeruk-100">
                <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=72&q=80" alt="Pengelolaan Lingkungan" class="mx-auto mb-6 rounded-full border-4 border-brand-jeruk/20">
                <h3 class="text-2xl font-semibold mb-3 text-brand-jeruk">Pengelolaan Lingkungan</h3>
                <p class="text-gray-700 leading-relaxed">Pelajari cara mengelola sumber daya alam dan lingkungan secara berkelanjutan.</p>
            </div>
            <div class="bg-brand-cream p-8 rounded-lg shadow hover:shadow-lg transition-all duration-300 text-center animate-up hover:bg-brand-jeruk-100">
                <img src="https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=72&q=80" alt="Teknologi Ramah Lingkungan" class="mx-auto mb-6 rounded-full border-4 border-brand-jeruk/20">
                <h3 class="text-2xl font-semibold mb-3 text-brand-jeruk">Teknologi Ramah Lingkungan</h3>
                <p class="text-gray-700 leading-relaxed">Kembangkan teknologi yang mendukung keberlanjutan lingkungan.</p>
            </div>
            <div class="bg-brand-cream p-8 rounded-lg shadow hover:shadow-lg transition-all duration-300 text-center animate-up hover:bg-brand-jeruk-100">
                <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=72&q=80" alt="Konservasi Sumber Daya" class="mx-auto mb-6 rounded-full border-4 border-brand-jeruk/20">
                <h3 class="text-2xl font-semibold mb-3 text-brand-jeruk">Konservasi Sumber Daya</h3>
        ...
        <section class="mt-20 max-w-4xl mx-auto px-4">
            <blockquote class="border-l-8 border-brand-jeruk pl-8 italic text-gray-800 text-lg leading-relaxed bg-brand-cream p-6 rounded-r-lg">
                ...
                <footer class="mt-6 font-semibold text-right text-brand-jeruk">- Alumni Teknik Lingkungan</footer>
            </blockquote>
        </section>
        ...
        <section class="mt-20 grid grid-cols-1 md:grid-cols-2 gap-20 max-w-6xl mx-auto px-4">
            <div>
                ...
                <ul class="list-disc list-inside text-gray-700 space-y-4">
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Pengantar Teknik Lingkungan</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Manajemen Limbah</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Pengolahan Air</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Kualitas Udara</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Dampak Lingkungan</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Konservasi Energi</a></li>
                </ul>
            </div>
            <div>
        ...
        <section class="bg-gradient-to-r from-brand-jeruk to-brand-jeruk-700 text-white text-center py-20 rounded-lg mt-20 shadow-xl">
            <h2 class="text-4xl font-bold mb-6">Mulai Karir Anda di Bidang Teknik Lingkungan.</h2>
