    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        <section class="relative bg-white shadow-md rounded-lg overflow-hidden mt-8 animate-up">
            ...
            <div class="absolute inset-0 bg-black bg-opacity-60 flex flex-col justify-center items-center text-center p-10">
                <h1 class="text-white text-5xl font-extrabold mb-4 leading-tight max-w-4xl">Fire Safety D3</h1>
                <p class="text-white text-xl mb-8 max-w-3xl">Program vokasi yang fokus pada pencegahan kebakaran, keselamatan kerja, dan manajemen risiko.</p>
        ...
        <section class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-12">
            <div class="bg-brand-cream p-8 rounded-lg shadow hover:shadow-lg transition-all duration-300 text-center animate-up hover:bg-brand-jeruk-100">
                <img src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=72&q=80" alt="Proteksi Kebakaran" class="mx-auto mb-6 rounded-full border-4 border-brand-jeruk/20">
                <h3 class="text-2xl font-semibold mb-3 text-brand-jeruk">Proteksi Kebakaran</h3>
            ...
            <div class="bg-brand-cream p-8 rounded-lg shadow hover:shadow-lg transition-all duration-300 text-center animate-up hover:bg-brand-jeruk-100">
                <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&w=72&q=80" alt="Evakuasi" class="mx-auto mb-6 rounded-full border-4 border-brand-jeruk/20">
                <h3 class="text-2xl font-semibold mb-3 text-brand-jeruk">Manajemen Keadaan Darurat</h3>
        ...
        <section class="bg-brand-jeruk text-white text-center py-20 rounded-lg mt-20 shadow-lg">
            <h2 class="text-4xl font-bold mb-6 max-w-3xl mx-auto">Bergabunglah dengan Program Studi Fire Safety D3.</h2>
        ...
        <section class="mt-20 max-w-4xl mx-auto px-4">
            <blockquote class="border-l-8 border-brand-jeruk pl-8 italic text-gray-800 text-lg leading-relaxed bg-brand-cream p-6 rounded-r-lg">
                "Program vokasi yang memberikan keterampilan praktis dalam pencegahan kebakaran dan keselamatan kerja."
                <footer class="mt-6 font-semibold text-right text-brand-jeruk">- Alumni Fire Safety</footer>
            </blockquote>
        </section>
        ...
        <section class="mt-20 grid grid-cols-1 md:grid-cols-2 gap-20 max-w-6xl mx-auto px-4">
            <div>
                ...
                <ul class="list-disc list-inside text-gray-700 space-y-4">
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Tata Cara Pencegahan Kebakaran Industri</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Sistem Proteksi Kebakaran (SPR, Sprinkler, Suppression)</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Penanganan Bahan Berbahaya (HAZMAT)</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Manajemen Keadaan Darurat & Evakuasi</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Inspeksi & Perawatan Peralatan Keselamatan</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Keselamatan Kerja di Lapangan Minyak</a></li>
                </ul>
            </div>
            <div>
        ...
        <section class="mt-20 text-center max-w-5xl mx-auto px-4">
            ...
            <div class="flex flex-wrap justify-center gap-16">
                ...
                <div class="w-40 group">
                    ...
                    <p class="text-gray-600 text-base">Ahli Keselamatan</p>
                </div>
                <div class="w-40 group">
                    <div class="relative mb-6">
                        <div class="absolute inset-0 bg-brand-jeruk rounded-full opacity-0 group-hover:opacity-20 transition-opacity"></div>
        ...
        <section class="bg-gradient-to-r from-brand-jeruk to-brand-jeruk-700 text-white text-center py-20 rounded-lg mt-20 shadow-xl">
            <h2 class="text-4xl font-bold mb-6">Mulai Karir Anda di Bidang Keselamatan & Pencegahan Kebakaran.</h2>
