<x-app-layout>
    <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        <section class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div class="bg-brand-cream p-8 rounded-lg shadow hover:shadow-lg transition-all duration-300 text-center animate-up hover:bg-brand-jeruk-100">
                <img src="https://images.unsplash.com/photo-1526256262350-7da7584cf5eb?auto=format&fit=crop&w=72&q=80" alt="Audit Keselamatan" class="mx-auto mb-6 rounded-full border-4 border-brand-jeruk/20">
                <h3 class="text-2xl font-semibold mb-3 text-brand-jeruk">Audit & Inspeksi</h3>
                <p class="text-gray-700 leading-relaxed">Metode audit, identifikasi bahaya, dan tindakan perbaikan.</p>
            </div>
            <div class="bg-brand-cream p-8 rounded-lg shadow hover:shadow-lg transition-all duration-300 text-center animate-up hover:bg-brand-jeruk-100">
                <img src="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&w=72&q=80" alt="Ergonomi" class="mx-auto mb-6 rounded-full border-4 border-brand-jeruk/20">
                <h3 class="text-2xl font-semibold mb-3 text-brand-jeruk">Ergonomi & Respons Darurat</h3>
                <p class="text-gray-700 leading-relaxed">Rancangan tempat kerja aman dan penanganan keadaan darurat.</p>
            </div>
        </section>

        <!-- Call to Action Banner -->
        <section class="bg-brand-jeruk text-white text-center py-20 rounded-lg mt-20 shadow-lg">
            <h2 class="text-4xl font-bold mb-6 max-w-3xl mx-auto">Bergabunglah dengan Program Studi Rekayasa Keselamatan & Kesehatan Kerja (RKK).</h2>
        ...
        <section class="mt-20 max-w-4xl mx-auto px-4">
            <blockquote class="border-l-8 border-brand-jeruk pl-8 italic text-gray-800 text-lg leading-relaxed bg-brand-cream p-6 rounded-r-lg">
                "Program ini memberikan pengetahuan yang mendalam tentang keselamatan kerja dan manajemen risiko industri."
                <footer class="mt-6 font-semibold text-right text-brand-jeruk">- Alumni RKK</footer>
            </blockquote>
        </section>
        ...
        <section class="mt-20 grid grid-cols-1 md:grid-cols-2 gap-20 max-w-6xl mx-auto px-4">
            <div>
                ...
                <ul class="list-disc list-inside text-gray-700 space-y-4">
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Dasar-dasar K3</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Manajemen Risiko Industri</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Audit & Inspeksi Keselamatan</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Ergonomi dan Keamanan Kerja</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Pencegahan dan Proteksi Kebakaran</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Hukum & Etika K3</a></li>
                </ul>
            </div>
            <div>
        ...
        <section class="bg-gradient-to-r from-brand-jeruk to-brand-jeruk-700 text-white text-center py-20 rounded-lg mt-20 shadow-xl">
            <h2 class="text-4xl font-bold mb-6">Mulai Karir Anda di Bidang Keselamatan Kerja dan Industri.</h2>
