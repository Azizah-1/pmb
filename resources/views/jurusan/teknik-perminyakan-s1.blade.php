    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        <section class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-12">
            <div class="bg-brand-cream p-8 rounded-lg shadow hover:shadow-lg transition-all duration-300 text-center animate-up hover:bg-brand-jeruk-100">
                <img src="https://images.unsplash.com/photo-1509395176047-4a66953fd231?auto=format&fit=crop&w=72&q=80" alt="Reservoir" class="mx-auto mb-6 rounded-full border-4 border-brand-jeruk/20">
                <h3 class="text-2xl font-semibold mb-3 text-brand-jeruk">Reservoir & Geologi</h3>
                <p class="text-gray-700 leading-relaxed">Pemahaman formasi geologi dan karakterisasi reservoir.</p>
            </div>
            <div class="bg-brand-cream p-8 rounded-lg shadow hover:shadow-lg transition-all duration-300 text-center animate-up hover:bg-brand-jeruk-100">
                <img src="https://images.unsplash.com/photo-1504274066651-8d31a536b11a?auto=format&fit=crop&w=72&q=80" alt="Drilling" class="mx-auto mb-6 rounded-full border-4 border-brand-jeruk/20">
                <h3 class="text-2xl font-semibold mb-3 text-brand-jeruk">Drilling & Well Engineering</h3>
                <p class="text-gray-700 leading-relaxed">Teknik pengeboran, desain sumur, dan manajemen wellbore.</p>
            </div>
            <div class="bg-brand-cream p-8 rounded-lg shadow hover:shadow-lg transition-all duration-300 text-center animate-up hover:bg-brand-jeruk-100">
                <img src="https://images.unsplash.com/photo-1542831371-d531d36971e6?auto=format&fit=crop&w=72&q=80" alt="Production" class="mx-auto mb-6 rounded-full border-4 border-brand-jeruk/20">
                <h3 class="text-2xl font-semibold mb-3 text-brand-jeruk">Produksi & Operasi Lapangan</h3>
        ...
        <section class="mt-20 max-w-4xl mx-auto px-4">
            <blockquote class="border-l-8 border-brand-jeruk pl-8 italic text-gray-800 text-lg leading-relaxed bg-brand-cream p-6 rounded-r-lg">
                ...
                <footer class="mt-6 font-semibold text-right text-brand-jeruk">- Alumni Teknik Perminyakan</footer>
            </blockquote>
        </section>
        ...
        <section class="mt-20 grid grid-cols-1 md:grid-cols-2 gap-20 max-w-6xl mx-auto px-4">
            <div>
                ...
                <ul class="list-disc list-inside text-gray-700 space-y-4">
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Geologi dan Reservoir</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Teknik Produksi Minyak & Gas</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Drilling & Well Engineering</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Komputasi Reservoir</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Pengolahan Migas</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Keselamatan dan Manajemen Lapangan</a></li>
                    <li><a href="#" class="text-brand-jeruk hover:text-brand-jeruk/70 transition-colors">Ekonomi Energi</a></li>
                </ul>
            </div>
            <div>
        ...
        <section class="mt-20 text-center max-w-5xl mx-auto px-4">
            ...
            <div class="flex flex-wrap justify-center gap-16">
                ...
                <div class="w-40 group">
                    ...
                    <p class="text-gray-600 text-base">Ahli Reservoir</p>
                </div>
                <div class="w-40 group">
                    <div class="relative mb-6">
                        <div class="absolute inset-0 bg-brand-jeruk rounded-full opacity-0 group-hover:opacity-20 transition-opacity"></div>
