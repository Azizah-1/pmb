    ...
    <div class="px-8 py-10 bg-gray-50 min-h-screen">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-10">
            <div class="bg-gradient-to-r from-orange-500 to-orange-400 text-white p-10 rounded-xl shadow-lg flex flex-col gap-6 md:w-1/2">
                ...
                <div class="teks" style="background: linear-gradient(to right, #fb6c13, #ff7141); padding: 20px; color: white; width: 50%; height: 500px; margin-top: 20px; gap: 20px;">
          ...
          <img src="{{ asset('news.jpg') }}" alt="pict" style="width: 800px; height: 500px; margin-top: 20px; margin-left: 0px;">
        </div>
    </div>
</x-app-layout>
